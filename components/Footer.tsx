...
export default function Footer() {
  ...
  return (
    <footer className="bg-bark text-cream-300/70 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-20">
          {/* Brand */}
          <div className="fade-footer-item col-span-2 lg:col-span-2">
            ...
            <div className="mt-8 inline-flex items-center gap-2 bg-brown-700/50 border border-gold-400/20 rounded-full px-4 py-2">
          ...
          <div className="fade-footer-item">
            <h4 className="font-body text-[10px] uppercase tracking-[0.2em] text-cream-100/40 mb-6">About Us</h4>
          ...
          {/* Help Centre */}
          <div className="fade-footer-item">
            <h4 className="font-body text-[10px] uppercase tracking-[0.2em] text-cream-100/40 mb-6">Help Centre</h4>
            <ul className="space-y-3">
          ...
          {/* Social */}
          <div className="fade-footer-item">
            <h4 className="font-body text-[10px] uppercase tracking-[0.2em] text-cream-100/40 mb-6">Social</h4>
            <ul className="space-y-3">
        ...
        {/* Legal Bottom */}
        <div className="border-t border-cream-100/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-body text-[10px] tracking-widest text-cream-100/30 uppercase">
